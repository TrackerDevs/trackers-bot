...
*/
exports.test = {
    data: (new builders_1.SlashCommandBuilder()).setDescription("testing stuff and such"),
    ...
    button: {
        "testing": async (interaction, bot, uuid) => {
            ...
            const firstActionRow = new builders_1.ActionRowBuilder().addComponents(favoriteColorInput);
            const secondActionRow = new builders_1.ActionRowBuilder().addComponents(hobbiesInput);
